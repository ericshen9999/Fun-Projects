        ...
        for i in possible:
            ...
            if i[1] not in pathMap.keys():
                ...
                if requiredItem != None:
                    ...
                    # if "iron_pickaxe" in i[1]['created'] and "furnace" not in i[1]['created']:
                    #     i[1]['created'] += " " + "furnace"
                    #     costofrequired += costDictionary["furnace"]
                    # if "iron_axe" in i[1]['created'] and "furnace" not in i[1]['created']:
                    #     i[1]['created'] += " " + "furnace"
                    #     costofrequired += costDictionary["furnace"]
                    # if "furnace" in i[1]['created'] and "stone_pickaxe" not in i[1]['created']:
                    #     i[1]['created'] += " " + "stone_pickaxe"
                    #     costofrequired += costDictionary["stone_pickaxe"]
                    # if "stone_pickaxe" in i[1]['created'] and "wooden_pickaxe" not in i[1]['created']:
                    #     i[1]['created'] += " " + "wooden_pickaxe"
                    #     costofrequired += costDictionary["wooden_pickaxe"]
                    # if "stone_axe" in i[1]['created'] and "wooden_pickaxe" not in i[1]['created']:
                    #     i[1]['created'] += " " + "wooden_pickaxe"
                    #     costofrequired += costDictionary["wooden_pickaxe"]
                    # if "wooden_pickaxe" in i[1]['created'] and "bench" not in i[1]['created']:
                    #     i[1]['created'] += " " + "bench"
                    #     costofrequired += costDictionary["bench"]
                    # if "wooden_axe" in i[1]['created'] and "bench" not in i[1]['created']:
                    #     i[1]['created'] += " " + "bench"
                    #     costofrequired += costDictionary["bench"]
...
if __name__ == '__main__':
    ...
    resulting_plan, useless = search(graph, state, is_goal, 30, heuristic,completed)
